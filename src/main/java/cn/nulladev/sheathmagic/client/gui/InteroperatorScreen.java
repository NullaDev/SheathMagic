...
public class InteroperatorScreen extends BaseContainerScreen<InteroperatorMenu> {

    public final InteroperatorMenu menu;

    public InteroperatorScreen(InteroperatorMenu menu, Inventory plInv, Component title) {
